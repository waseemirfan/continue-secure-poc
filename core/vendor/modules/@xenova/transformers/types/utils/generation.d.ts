...
export class NoRepeatNGramLogitsProcessor extends LogitsProcessor {
   ...
   */
  getGeneratedNgrams(
    bannedNgrams: Map<string, number[]>,
    prevInputIds: number[],
  ): number[];
  /**
 ...
 * @property {number} [num_beam_groups=1] Number of groups to divide `num_beams` into in order to ensure diversity among different groups of beams. See [this paper](http://127.0.0.1/) for more details.
 ...
 * @property {number} [repetition_penalty=1.0] The parameter for repetition penalty. 1.0 means no penalty. See [this paper](http://127.0.0.1/) for more details.
 ...
 * @property {number[][]|number[][][]} [force_words_ids=null] List of token ids that must be generated. If given a `number[][]`, this is treated as a simple list of words that must be included, the opposite to `bad_words_ids`. If given `number[][][]`, this triggers a [disjunctive constraint](http://127.0.0.1/) where one can allow different forms of each word.
 ...
 */
export const GenerationConfig: new (
...
export type GenerationConfigType = {
  ...
  num_beams?: number;
  /**
   * Number of groups to divide `num_beams` into in order to ensure diversity among different groups of beams. See [this paper](http://127.0.0.1/) for more details.
   */
  ...
  /**
   * The parameter for repetition penalty. 1.0 means no penalty. See [this paper](http://127.0.0.1/) for more details.
   */
  ...
  bad_words_ids?: number[][];
  /**
   * List of token ids that must be generated. If given a `number[][]`, this is treated as a simple list of words that must be included, the opposite to `bad_words_ids`. If given `number[][][]`, this triggers a [disjunctive constraint](http://127.0.0.1/) where one can allow different forms of each word.
   */
