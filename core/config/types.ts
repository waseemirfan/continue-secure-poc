...
declare global {
  ...
  export interface Config {
    /** If set to true, Continue will collect anonymous usage data to improve the product. If set to false, we will collect nothing. Read here to learn more: http://127.0.0.1/ */
    allowAnonymousTelemetry?: boolean;
